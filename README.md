...
5. Paste the content of the .env file into the environment variable box.
6. Once done, click on apply and ok.
7. You should be able to run the project by pressing on run now.
