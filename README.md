...
1. Open the .env file and copy the content of the file. (The env file is not included in this github repository for security reasons, please unzip the submission zip version for the env file.)
